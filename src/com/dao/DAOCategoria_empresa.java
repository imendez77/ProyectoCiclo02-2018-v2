...
/**
 * Nombre:DAOCategoria_empresa Version:1.0 Fecha:06/09/2018 CopyRight:ITCA
 *
...
public class DAOCategoria_empresa implements Operaciones {
    ...
    public ArrayList<Object[]> mostrar2() {
        ...
        PreparedStatement pst;
        ResultSet rs;
        String sql = "select id_catg_empresa,categoria,descripcion,estado from categoria_empresa";
    ...
    public int buscar_id(String nombre) {
        ...
        PreparedStatement pst;
        ResultSet rs;
        String sql = "select id_catg_empresa from categoria_empresa where categoria='"+nombre+"'";
        int id;
        try {
            Class.forName(db.getDriver());
            con = DriverManager.getConnection(db.getUrl(), db.getUser(), db.getPassword());
            ...
            while (rs.next()) {
                catE.setId_catg_empresa(rs.getInt("id_catg_empresa"));
